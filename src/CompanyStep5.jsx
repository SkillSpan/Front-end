...
function CompanyStep5({ onNavigateToLanding, onNavigateToLogin, organizationEmail }) {
  return (
              ...
              <div style={{ display: 'flex', gap: '15px', alignItems: 'flex-start' }}>
                ...
                <div>
                  ...
                  <div style={{ color: '#94a3b8', fontSize: '0.75rem', lineHeight: '1.4' }}>
                    Your email {organizationEmail ? <strong>{organizationEmail}</strong> : ''} has been verified.<br />
