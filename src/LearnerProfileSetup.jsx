...
// Reference universities for the West Bank / Palestine region, since that's
// who this build is currently serving. "Other" always lets someone type
// their own so this never blocks a real submission.
const UNIVERSITIES = [
